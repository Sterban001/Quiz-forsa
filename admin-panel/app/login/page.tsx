  ...
  useEffect(() => {
    ...
    if (errorParam) {
      const errorMessages: Record<string, string> = {
        'admin_required': 'Access denied. Admin role required to access this panel.',
        ...
        <div className="bg-white rounded-lg shadow-xl p-8">
          ...
          <form onSubmit={handlePasswordLogin} className="space-y-4">
            ...
            <button
              ...
              disabled={loading}
              className="w-full flex items-center justify-center gap-3 bg-white border border-gray-300 text-gray-700 py-2 px-4 rounded-md hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
